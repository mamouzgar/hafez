...
## (2) Docker image. 
A dockerfile is present in this repository. Follow the instructions below:
...
4. Run the docker image. You can change the port and password as you wish. You can also mount a local directory to the docker container to access local data and save your results. In this example, I mount a local directory called "~/Rpackages/hafez/data" in the hafez repo to the "/home/rstudio/data" directory in the docker container. Now, files saved in "/home/rstudio/data/" will live on the host machine path you provided  (i.e., "~/Rpackages/hafez/data") so your files will be saved on the host machine even if the container is deleted.
